...
export class Footer extends Component {
  render() {
    return (
      <div className='container-fluid footer pt-4 mt-5 bg-dark text-center'>
        <div className='row bg-dark '>
        <div className='col-md-6 col-sm-12 col-xs-12'>
            <img src={image5} alt="" className='f-job pb-4'/>
        </div>
        <div className='col-md-6 col-sm-12 col-xs-12 text-sm '>
          ...
          {/* <button type='button' className='bg-white border-0'>
            ...
            <img src={Vector2} alt="" className='f-logo ms-2'/>
            <img src={Vector1} alt="" className='f-logo ms-2'/>
            </span>
          </div>    
        </div>
        </div> 
